...
public class DexFileReader implements BaseDexFileReader {
    ...
    protected static final int DBG_END_SEQUENCE = 0x00;
    protected static final int DBG_ADVANCE_PC = 0x01;
    protected static final int DBG_ADVANCE_LINE = 0x02;
    protected static final int DBG_START_LOCAL = 0x03;
    protected static final int DBG_START_LOCAL_EXTENDED = 0x04;
    protected static final int DBG_END_LOCAL = 0x05;
    protected static final int DBG_RESTART_LOCAL = 0x06;
    protected static final int DBG_SET_PROLOGUE_END = 0x07;
    protected static final int DBG_SET_EPILOGUE_BEGIN = 0x08;
    protected static final int DBG_SET_FILE = 0x09;
    protected static final int DBG_FIRST_SPECIAL = 0x0a;
    protected static final int DBG_LINE_BASE = -4;
    protected static final int DBG_LINE_RANGE = 15;
    ...
    protected final ByteBuffer codeItemIn;
    ...
    protected final ByteBuffer debugInfoIn;
    ...
    protected void acceptCode(int code_off, DexCodeVisitor dcv, int config, boolean isStatic, Method method) {
